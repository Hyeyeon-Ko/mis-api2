...
public interface DocListService {
    List<DocResponseDTO> getReceiveApplyList(String searchType, String keyword, String instCd);
    List<DocResponseDTO> getDeptReceiveApplyList(String deptCd);
    List<DocResponseDTO> getSendApplyList(String searchType, String keyword, String instCd);
