...
/*    @Operation(summary = "get center Info", description = "기준자료 > 중분류 정보 호출 시 사용")
    @GetMapping("/info")
    public ResponseEntity<List<StdDetailResponseDTO>> getCenterInfo(@RequestParam("clsCd") String clsCd,
                                                                    @RequestParam("etcCd") String etcCd) {

        List<StdDetailResponseDTO> stdDetailResponses = stdDetailService.getInfo(clsCd, etcCd);
    ...
    @PostMapping("/info")
    public ResponseEntity<String> addCenterInfo(StdDetailRequestDTO stdDetailRequestDTO) {
...
/*    @Operation(summary = "update center Info", description = "기준자료 > 소분류 정보 수정 시 사용")
    @PutMapping("/info")
    public ResponseEntity<String> updateCenterInfo(StdDetailRequestDTO stdDetailRequestDTO) {
...
/*    @Operation(summary = "delete center Info", description = "기준자료 > 소분류 정보 삭제 시 사용")
    @DeleteMapping("/info")
    public ResponseEntity<String> deleteCenterInfo(String clsCd, String etcCd, String etcDetlCd) {

        stdDetailService.deleteInfo(clsCd, etcCd, etcDetlCd);
