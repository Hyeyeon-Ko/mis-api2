...
public class CorpDocConfirmController {
    ...
    @PutMapping("/approve")
    public ApiResponse<?> approve(@RequestParam("draftId") String draftId) {
    ...
    @PutMapping("/reject")
    public ApiResponse<?> reject(@RequestParam("draftId") String draftId, @RequestBody String rejectReason) {
