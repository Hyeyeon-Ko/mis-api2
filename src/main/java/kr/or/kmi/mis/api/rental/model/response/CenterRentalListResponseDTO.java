...
public class CenterRentalListResponseDTO {
    ...
    public static CenterRentalListResponseDTO of(List<RentalResponseDTO> foundationResponses, List<RentalResponseDTO> gwanghwamunResponses,
                                                     List<RentalResponseDTO> yeouidoResponses, List<RentalResponseDTO> gangnamResponses,
                                                     List<RentalResponseDTO> suwonResponses, List<RentalResponseDTO> daeguResponses,
                                                     List<RentalResponseDTO> busanResponses, List<RentalResponseDTO> gwangjuResponses,
                                                     List<RentalResponseDTO> jejuResponses) {
